...
import com.kennethtoxcon.sessionbeans.CotizaciondetalleFacadeLocal;
...
public class CotizaciondetalleController implements Serializable {
    ...
    @EJB
    private CotizaciondetalleFacadeLocal ejbFacade;
    ...
    public Cotizaciondetalle getCotizaciondetalle(java.lang.Integer id) {
    ...
    public static class CotizaciondetalleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cotizaciondetalle) {
                ...
                return getStringKey(o.getIdcotizaciondetalle());
            } else {
